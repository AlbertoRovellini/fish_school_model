...
write.table(fishOnFoodAll, "C:/Users/Alberto/Documents/swarm_runs/new_output_Std/fishOnFoodSchool_reverted.csv") # writes .csv output 
ggsave("Second plot swarm reverted.pdf", plotFishOnFoodSwarm, useDingbats=FALSE)
