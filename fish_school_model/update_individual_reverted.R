...
write.table(fishOnFoodPerUpdateTime, "C:/Users/Alberto/Documents/swarm_runs/new_output_CA/update_individual_reverted.csv")

ggsave("update_individual_reverted.pdf", plotFishOnFoodPerUpdateTime, useDingbats=FALSE)